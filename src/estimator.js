...
const covid19ImpactEstimator = (data) => {
  ...
  const severeCasesByRequestedTimeImpact = Math.floor(0.15 * Math.floor(infectionsByRequestedTimeImpact));
  const severeCasesByRequestedTimeSevereImpact = Math.floor(0.15 * Math.floor(infectionsByRequestedTimeSevereImpact));
